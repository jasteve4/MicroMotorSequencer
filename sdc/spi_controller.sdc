...
set_load -pin_load 0.0334 [get_ports {miso_oeb}]
set_load -pin_load 0.0334 [get_ports {mosi_oeb}]
set_load -pin_load 0.0334 [get_ports {sclk_oeb}]
set_load -pin_load 0.0334 [get_ports {ss_n_oeb}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {ss_n}]
